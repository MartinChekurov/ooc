...
void test_linked_hash_set_create_destroy(void) {
    void* set = ooc_new(ooc_linkedHashSetClass(), (size_t)0);
...
void test_linked_hash_set_remove_and_readd(void) {
    ...
    TEST_ASSERT_TRUE(ooc_equals(e3, s1));
...
void test_linked_hash_set_equals_with_hash_set(void) {
    void* lset = ooc_new(ooc_linkedHashSetClass(), (size_t)0);
    void* hset = ooc_new(ooc_hashSetClass(), (size_t)0);
